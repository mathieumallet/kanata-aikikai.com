...
<h2 class="red-text">Aikido Primer</h2>

<p>by Eric Sotnak, April 22nd 1993
<br><i>Please read the copyright notice at the bottom</i>
...
<UL>
  ...
  <LI> <A HREF="#questions"> Answers to Some Common Questions </A> 

  <LI> <A HREF="#weapons"> Weapons Training </A> 

  <LI> <A HREF="#bowing"> About Bowing </a>

  <LI><A HREF="#mind"> Training the Mind in Aikido</A> 

  <LI> <A HREF="#ki"> A Note on Ki </A> 

  <LI> <A HREF="#etiquette"> Etiquette </A> 

  <LI> <A HREF="#vocab"> Basic Aikido Vocabulary</A> 

  <LI> <A HREF="#attacks"> Common Attacks</A> 

  <LI> <A HREF="#tech"> Basic Techniques</A> 

  <LI> <A HREF="#throws"> Throws</A> 

  <LI> <A HREF="#pronounce"> Pronunciation </A> 

  <LI> <A HREF="#count"> Counting to 10 in Japanese</A> 

  <LI> <A HREF="#jo20"> Saito Sensei's 20 JO SUBURI</A> 

  <LI> <A HREF="#teachings"> O-sensei Teachings</A>
...
<p>Although aikido is a relatively recent innovation 
...
<P> Aikido is not primarily a system of combat, 
...
<P> At the same time, the potential of aikido as 
  ...
  substantial risk. 
<P> It must be emphasized that there are no shortcuts 
...
<p>Aikido's founder, Morihei Ueshiba, was born 
...
<P> On the technical side, aikido is rooted in several 
...
<P> On the religious side, Ueshiba was a devotee 
...
<P> Despite what many people think or claim, there 
  ...
  about aikido. 
<P> Some examples: "Aikido is not a way to fight 
...
<P> At the core of almost all philosophical interpretations 
...
<A NAME="training"></A> 
<H3>Training</H3>
<p>Aikido practice begins the moment you enter 
...
(kneeling).*  
<P> The only way to advance in aikido is through 
  ...
  attendance. 
<P> Your training is your own responsibility. No 
  ...
  by watching others. 
<P> Aikido training encompasses more than techniques. 
...
<P> The following point is very important: Aikido 
  ...
  lent you. 
<P> Aikido training may sometimes be very frustrating. 
...
<P> If at any time during aikido training you become 
...
<P> * If you are unable to sit in seiza, you may 
  sit cross-legged instead.  

<A NAME="questions"></A>
<H3>Answers to Some Common Questions</H3>
<p>1. Q: How do ranks and promotions work in aikido, 
and how come there are no colored belts?  
<P> A: According to the standard set by the International 
...
<P> Eligibility for testing depends primarily (though 
...
<P> 2. Q: What if I can't throw my partner? 
<P> A: This is a common question in aikido. There 
  are several answers. First, ask the instructor. Perhaps there is something 
  you are doing incorrectly. 
<P> Second, aikido techniques, as we practice them 
...
<P> Third, aikido techniques often take a while 
...
<P> Fourth, many aikido techniques cannot be performed 
...
<P> 3. Q: How would an aikidoist fare against someone 
  trained in karate/judo/tae kwon do/ninjutsu/kickboxing/... 
<P> A1: It depends on the specific capabilities 
  of the individuals involved. 
<P> A2: Who cares? The purpose of aikido isn't to 
  learn to defeat other martial artists. 
<P> A3 (slightly cryptic -- think about it): Offense 
  calls for offensive strategies. Defense calls for defensive strategies. 
   
<P> 4. Q: How often should I practice? 
<P> A: As often or as seldom as you wish. However, 
  a mimimum of two practices per week is advised. 
<P> 5. Q: How can I practice by myself? 
<P> A: Naturally, aikido is best learned with a 
...
<P> Second, one can "shadow" techniques by simply 
...
<p>Some dojo hold classes which are devoted almost 
...
<P> There are several reasons for weapons training 
...
<P> Second, weapons training is helpful for learning 
  proper MA AI, or distancing. 
<P> Third, many advanced aikido techniques involve 
...
<P> movement and technique that may be more easily 
  demonstrated by the use of weapons than without. 
<P> Fifth, training in weapons kata is a way of 
  facilitating understanding of general principles of aikido movement. 
<P> Sixth, weapons training can add an element of 
  intensity to aikido practice, especially in practicing defenses against 
  weapons attacks. 
<P> Seventh, training with weapons provides aikidoka 
...
<P> Finally, weapons training is an excellent way 
...
<A NAME="bowing"></A>
<H3>About Bowing</H3>
<p>It is common for people to ask about the practice 
...
all these functions.  
<P> Incorporating this particular aspect of Japanese 
  culture into our aikido practice serves several purposes: 
<P> It inculcates a familiarity with an important 
...
<P> When bowing either to the instructor at the 
...
<A NAME="mind"></A>
<H3>Training the Mind in Aikido</H3>
<p>The founder (Morihei Ueshiba) intended aikido 
...
<P> It should be clear that any transformative power 
...
<P> Classically, those arts which claim to provide 
...
<P> So far as the incorporation of Zen and Taoist 
  ...
  practice. 
<P> The fact that aikido training is always cooperative 
...
<A NAME="ki"></A>
<H3>A Note on Ki</H3>
<p>The concept of KI is one of the most difficult 
...
metaphysic).  
<P> Modern aikidoka are less concerned with the 
...
<P> There are a number of aikidoka who claim to 
  ...
  KI. 
<P> Not all aikidoka believe that KI is a kind of 
...
<P> In addition, to the extent that aikido is not 
...
<ol>
  <LI> When entering or leaving the dojo, it 
    ...
    the mat.  
  <LI> No shoes on the mat.  
  <LI> Be on time for class. Students should 
    ...
    to join practice.  
  <LI> If you should have to leave the mat or 
    dojo for any reason during class, approach the instructor and ask 
    permission.  
  <LI> Avoid sitting on the mat with your back 
    ...
    or cross- legged.)  
  <LI> Remove watches, rings and other jewelry 
    before practice.  
  <LI> Do not bring food, gum, or beverages with 
    you into the dojo.  
  <LI> Please keep your finger and toe nails 
    cut short.  
  <LI> Please keep talking during class to a 
    minimum. What conversation there is should be restricted to one topic 
    -- Aikido.  
  <LI> If you are having trouble with a technique, 
    ...
    help.  
  <LI> Carry out the directives of the instructor 
    PROMPTLY. Do not keep the rest of the class waiting for you!  
  <LI> Do not engage in rough-housing or needless 
    contests of strength during class.  
  <LI> Keep your training uniform clean, in 
    good shape, and free of offensive odors.  
  <LI> Please pay your membership dues promptly. 
  ...
  <LI> Do not change your clothes on the mat. 
     
  <LI> Remember that you are here to learn, 
    and not to gratify your ego. An attitude of receptivity and humility 
    (though not obsequiousness) is therefore advised.  
  <LI> Preserve common-sense standards of decency 
    and respect at all times.  
</ol>

<A NAME="vocab"></A>
<H3>Basic Aikido Vocabulary</H3>
<p>AGATSU = "Self victory." According to the founder, 
...
<P> AIKIDO = The word "aikido" is made up of three 
...
<P> AIKIDOKA = A practitioner of aikido. 
<P> AIKIKAI = "Aiki association." A term used to 
  designate the organization created by the founder for the dissemination 
  of aikido. 
<P> AI HANMI = Mutual stance where UKE and NAGE 
  each have the same foot forward (right-right, left-left). 
<P> AI NUKE = "Mutual escape." An outcome of a duel 
  ...
  party involved. 
<P> AI UCHI = "Mutual kill." An outcome of a duel 
...
<P> ASHI SABAKI = Footwork. Proper footwork is essential 
  in aikido for developing strong balance and for facilitating ease of 
  movement. 
<P> ATEMI = (lit. Striking the Body) Strike directed 
...
<P> BOKKEN = BOKUTO = Wooden sword. Many aikido 
...
<P> BUDO = "Martial way." The Japanese character 
...
<P> CHOKUSEN = Direct. Thus CHOKUSEN NO IRIMI = 
  direct entry. 
<P> CHUDAN = "Middle position." Thus CHUDAN NO KAMAE 
  = a stance characterized by having one's hands/sword in a central position 
  with respect to one's body. 
<P> CHUSHIN = Center. Especially, the center of 
  one's movement or balance. 
<P> DAN = Black belt rank. In IAF aikido, the highest 
  ...
  KYU ranks. 
<P> DO = Way/path. The Japanese character for "DO" 
...
<P> DOJO = Literally "place of the Way." Also "place 
...
<P> FUDO SHIN = "Immovable mind." A state of mental 
...
<P> FUKUSHIDOIN = A formal title whose connotation 
  is something approximating "assistant instructor." 
<P> FURI KABURI = Sword-raising movement. This movement 
  in found especially in IKKYO, IRIMI-NAGE, and SHIHO-NAGE. 
<P> GEDAN = Lower position. GEDAN NO KAMAE is thus 
  a stance with the hands or a weapon held in a lower position. 
<P> GI (DO GI) (KEIKO GI) = Training costume. Either 
...
<P> HANMI HANDACHI = Position with NAGE sitting, 
  ...
  (HARA). 
<P> HAPPO = 8 directions; as in HAPPO-UNDO (8 direction 
...
<P> HARA = One's center of mass, located about 2" 
...
<P> HASSO NO KAMAE = "Figure-eight" stance. The 
...
<P> JINJA = A (shinto) shrine. There is an AIKI 
  JINJA located in Iwama, Ibaraki prefecture, Japan. 
<P> JIYU WAZA = Free-style practice of techniques. 
  This usually involves more than one attacker who may attack NAGE in 
  any way desired. 
<P> JO = Wooden staff about 4'-5' in length. The 
...
<P> JODAN = Upper position. JODAN NO KAMAE is thus 
  a stance with the hands or a weapon held in a high position. 
<P> KACHIHAYABI = "Victory at the speed of sunlight." 
...
<P> KAESHI WAZA = Technique reversal. (UKE becomes 
...
<P> KAISO = A title. The founder of aikido (i.e., 
  Morihei Ueshiba). 
<P> KAMAE = A posture or stance either with or without 
  ...
  in aikido. 
<P> KAMI = A divinity, living force, or spirit. 
...
<P> KAMIZA = A small shrine, especially in an aikido, 
...
<P> KANSETSU WAZA = Joint manipulation techniques. 
<P> KATA = A "form" or prescribed pattern of movement, 
  especially with the JO in aikido. (But also "shoulder.") 
<P> KATAME WAZA = "Hold-down" (pinning) techniques. 
<P> KATANA = What is vulgarly called a "samurai 
  sword." 
<P> KATSU JIN KEN = "The sword that saves life." 
...
<P> KEIKO = Training. The only secret to success 
  in aikido. 
<P> KEN = Sword. 
<P> KENSHO = Enlightenment. (see MOKUSO and SATORI) 
<P> KI = Mind. Spirit. Energy. Vital-force. Intention. 
...
<P> KIAI = A shout delivered for the purpose of 
...
<P> KIHON = (Something which is) fundamental. There 
...
<P> KI MUSUBI = KI NO MUSUBI = Literally "knotting/tying-up 
...
<P> KOHAI = A student junior to oneself. 
<P> KOKORO = "Heart or mind." Japanese folk psychology 
  does not distinguish clearly between the seat of intellect and the seat 
  of emotion as does Western folk psychology. 
<P> KOKYU = Breath. Part of aikido is the development 
  ...
  RYOKU. 
<P> KOTODAMA = A practice of intoning various sounds 
...
<P> KU = Emptiness. According to Buddhism, the fundamental 
...
<P> KUMIJO = JO matching exercise (partner practice). 
<P> KUMITACHI = Sword matching exercise (partner 
  practice). 
<P> KUZUSHI = The principle of destroying one's 
...
<P> KYU = White belt rank. (Or any rank below SHODAN) 
<P> MA AI = Proper distancing or timing with respect 
...
<P> MAE = Front. Thus MAE UKEMI = "forward fall/roll". 
<P> MASAKATSU = "True victory." (see AGATSU and 
  KACHIHAYABI) MIGI = Right. 
<P> MISOGI = Ritual purification. Aikido training 
...
<P> MOKUSO = Meditation. Practice often begins or 
  ...
  collapses. 
<P> MUDANSHA = Students without black-belt ranking. 
<P> MUSHIN = Literally "no mind". A state of cognitive 
...
<P> NAGARE = Flowing. One goal of aikido practice 
...
<P> OBI = A belt. 
<P> OMOTE = "The front," thus, a class of movements 
  in aikido in which NAGE enters in front of UKE. 
<P> OMOTOKYO = One of the so-called "new-religions" 
  ...
  purpose. 
<P> ONEGAI SHIMASU = "I welcome you to train with 
  me," or literally, "I make a request." This is said to one's partner 
  when initiating practice. 
<P> OSAE WAZA = Pinning techniques. 
<P> O-SENSEI = Literally, "Great Teacher," i.e., 
  Morihei Ueshiba, the founder of aikido. 
<P> RANDORI = Free-style "all-out" training. Sometimes 
...
<P> REIGI = Ettiquette. Observance of proper ettiquette 
...
<P> SATORI = Enlightenment. In Buddhism, enlightenment 
...
<P> SENSEI = Teacher. It is usually considered proper 
  ...
  off the mat as well. 
<P> SEIZA = Sitting on one's knees. Sitting this 
  way requires acclimatization, but provides both a stable base and greater 
  ease of movement than sitting cross-legged. 
<P> SEMPAI = A student senior to oneself. 
<P> SETSU NIN TO = "The sword that kills." Although 
  ...
  KEN coalesce. 
<P> SETSUZOKU = Connection. Aikido techniques are 
...
<P> SHIDOIN = A formal title meaning, approximately, 
  "instructor." 
<P> SHIHAN = A formal title meaning, approximately, 
  "master instructor." A "teacher of teachers." 
<P> SHIKAKU = Literally "dead angle." A position 
...
<P> SHIKKO = Samurai walking ("knee walking"). Shikko 
...
<P> SHINKENSHOBU = Lit. "Duel with live swords." 
  ...
  on the duel. 
<P> SHINNYO = "Thusness" or "suchness." A term commonly 
...
<P> SHINTO = "The way of the gods." The indigenous 
...
<P> SHODAN = First degree black belt. 
<P> SHOMEN = Front or top of head. Also the designated 
  front of a DOJO. 
<P> SOTO = "Outside." Thus, a class of aikido movements 
  executed, especially, outside the attacker's arm(s). (see UCHI) 
<P> SUBURI = Basic JO or BOKKEN practice in striking 
  and thrusting. 
<P> SUKASHIWAZA = Techniques performed without allowing 
...
<P> SUKI = An opening or gap where one is vulnerable 
...
<P> SUTEMI = Literally "to throw-away the body." 
...
<P> SUWARI WAZA = Techniques executed with both 
...
<P> TACHI = A type of Japanese sword (thus TACHI-TORI 
  = sword-taking). (Also "standing position"). 
<P> TACHI WAZA = Standing techniques. 
<P> TAIJUTSU = "Body arts," i.e., unarmed practice. 
<P> TAI NO HENKO = TAI NO TENKAN = Basic blending 
  practice involving turning 180 degrees. 
<P> TAI SABAKI = Body movement. 
<P> TAKEMUSU AIKI = A "slogan" of the founder's 
...
<P> TANINSUGAKE = Training against multiple attackers, 
  usually from grabbing attacks. 
<P> TANTO = A dagger. 
<P> TEGATANA = "Hand sword", i.e. the edge of the 
...
<P> TENKAN = Turning movement, esp. turning the 
  body 180 degrees. (see TAI NO TENKAN) 
<P> TENSHIN = A movement where NAGE retreats 45 
  degrees away from the attack (esp. to UKE's open side). 
<P> TSUKI = A punch or thrust (esp. an attack to 
  the midsection). 
<P> UCHI = "Inside." A class of techniques where 
  NAGE moves, especially, inside (under) the attacker's arm(s). (but also 
  a strike, e.g., SHOMEN UCHI) 
<P> UCHI DESHI = A live-in student. A student who 
  ...
  of the dojo). 
<P> UESHIBA KISSHOMARU = The son of the founder 
  of aikido and current aikido DOSHU. 
<P> UESHIBA MORIHEI = The founder of aikido. (see 
  O-SENSEI and KAISO). 
<P> UESHIBA MORITERU = The grandson of the founder 
  and current DOJOCHO at HOMBU DOJO. 
<P> UKE = Person being thrown (receiving the technique). 
...
<P> UKEMI = Literally "receiving [with/through] 
...
<P> URA = "Rear." A class of aikido techniques executed 
  by moving behind the attacker and turning. Sometimes URA techniques 
  are called TENKAN (turning) techniques. 
<P> USHIRO = Backwards or behind, as in USHIRO UKEMI 
  or falling backwards. 
<P> WAZA = Techniques. Although in aikido we have 
...
<P> x-TORI (x-DORI) = Taking away x, e.g. TANTO-TORI 
  (knife-taking). YOKO = Side. 
<P> YOKOMEN = Side of the head. 
<P> YUDANSHA = Black belt holder (any rank). 
<P> ZANSHIN = Lit. "remaining mind/heart." Even 
...
<P> ZEN = A school or division of Buddhism characterized 
...
<P> ZORI = Sandals worn off the mat to help keep 
  the mat clean!  

<A NAME="attacks"></A>
<H3>Common Attacks</H3>
<p>KATATE TORI = One hand holding one hand.<BR>
MOROTE TORI = Two hands holding one hand.<BR>
KATA TORI = Shoulder hold.<BR>
RYO KATA TORI = Grabbing both shoulders.<BR>
RYOTE TORI = Two hands holding two hands.<BR>
MUNE DORI = One or two hand lapel hold.<BR>
HIJI TORI = Elbow grab.<BR>
USHIRO TEKUBI TORI = Wrist grab from the back.<BR>
USHIRO RYOTE TORI = As above from the back.<BR>
USHIRO RYO KATA TORI = As above from the back.<BR>
USHIRO KUBI SHIME = Rear choke.  
<P> SHOMEN UCHI = Overhead strike to the head.<BR>
  YOKOMEN UCHI = Diagonal strike to the side of the head.<BR>
  TSUKI = Straight thrust (punch), esp. to the midsection.  <A NAME="tech"> 
  </A>

<A NAME="tech"> </A>
<H3>Basic Techniques:</H3>
<p>IKKYO = OMOTE and URA (IRIMI and TENKAN)<BR>
NIKYO = OMOTE and URA (IRIMI and TENKAN)<BR>
SANKYO = OMOTE and URA (IRIMI and TENKAN)<BR>
YONKYO = OMOTE and URA (IRIMI and TENKAN)<BR>
GOKYO = OMOTE and URA (IRIMI and TENKAN)<BR>

<A NAME="throws"></A>
<H3>Throws:</H3>
<p>IRIMI NAGE = Entering throw ("20 year" technique).<BR>
JUJI NAGE = Arm entwining throw.<BR>
KAITEN NAGE = Rotary throw. UCHI and SOTO, OMOTE and URA (IRIMI and TENKAN)<BR>
KOKYU NAGE = Breath throws.<BR>
KOSHI NAGE = Hip throw.<BR>
KOTE GAESHI = Wrist turn-out.<BR>
SHIHO NAGE = "Four direction" throw.<BR>
SUMIOTOSHI = "Corner drop." OMOTE and URA (IRIMI and TENKAN).<BR>
TENCHI NAGE = "Heaven and earth" throw. OMOTE and URA (IRIMI and TENKAN).<BR>
...
I = pIzza<BR>
U = blUe<BR>
E = somewhere between Echo and tAble<BR>
O = bOne  

<A NAME="count"></A>
<H3>Counting to 10 in Japanese:</H3>
<p>ICHI, NI, SAN, SHI (YON), GO, ROKU, SHICHI 
(NANA), HACHI, KYU (KU), JU. 

<A NAME="jo20"></A>
<H3>Saito Sensei's 20 JO SUBURI</H3>
<p> TSUKI Series:  
<P> 1. CHOKU TSUKI<BR>
  2. KAESHI TSUKI<BR>
  3. USHIRO TSUKI<BR>
  4. TSUKI GEDAN GAESHI<BR>
  5. TSUKI JODAN GAESHI UCHI 
<P> UCHIKOMI Series: 
<P> 6. SHOMEN UCHIKOMI<BR>
  7. RENZOKU UCHIKOMI<BR>
  8. MENUCHI GEDAN GAESHI<BR>
  9. MENUCHI USHIRO TSUKI<BR>
  10. GYAKU YOKOMEN USHIRO TSUKI 
<P> KATATE Series: 
<P> 11. KATATE GEDAN GAESHI<BR>
  12. KATATE TOMA UCHI<BR>
  13. KATATE HACHI NO JI GAESHI 
<P> HASSO GAESHI Series: 
<P> 14. HASSO GAESHI UCHI<BR>
  15. HASSO GAESHI TSUKI<BR>
  16. HASSO GAESHI USHIRO TSUKI<BR>
  17. HASSO GAESHI USHIRO UCHI<BR>
  18. HASSO GAESHI USHIRO HARAI 
<P> NAGARE Series: 
<P> 19. (HIDARI) NAGARE GAESHI UCHI (usually left 
  side only)<BR>
  20. (MIGI) NAGARE GAESHI TSUKI (usually right side only) 

<A NAME="teachings"></A>
<H3>O-sensei teachings</H3>
<P>The following are some of the founder's teachings 
  concerning the essence of aikido:
<P> Aikido is a manifestation of a way to reorder 
  the world of humanity as though everyone were of one family. Its purpose 
  is to build a paradise right here on earth. 
<P> Aikido is nothing but an expression of the spirit 
  of Love for all living things. 
<P> It is important not to be concerned with thoughts 
  of victory and defeat. Rather, you should let the KI of your thoughts 
  and feelings blend with the Universal. 
<P> Aikido is not an art to fight with enemies and 
...
<P> If anyone tries to fight me, it means that s/he 
  ...
  is defeated. 
<P> Nonresistance is one of the principles of aikido. 
...
<h3>Copyright Notice</h3>
  ...
  <P>This version is dated April 22, 1993.

  <P>Please send comments, complaints, and suggestions to: <a href="mailto:esot@troi.cc.rochester.edu">Eric Sotnak</a>
